    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_select(id) {
         document.listForm.selectedId.value = id;
           ...
           var view_YN = (document.getElementById(id).innerHTML);
           
           /* 문자열 공백제거를 위한 함수 */
           view_YN =view_YN.trim();
          
           if(view_YN=="Y"){
            document.listForm.action = "<c:url value='/passwordSampleView.do'/>";
           } else {
...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    <form:form commandName="searchVO" id="listForm" name="listForm" method="get">
        ...
        <div id="content_pop">
        	...
        	<!-- List -->
        	<div id="table">
        		<table width="100%" border="0" cellpadding="0" cellspacing="0" summary="카테고리ID, 케테고리명, 사용여부, Description, Description2, 등록자, 등록일 표시하는 테이블">
        			<caption style="visibility:hidden">카테고리ID, 케테고리명, 사용여부, Description, Description2, 등록자, 등록일 표시하는 테이블</caption>
        			<colgroup>
        				<col width="40"/>
        				<col width="100"/>
        				<col width="150"/>
        			...
        			<tr>
        				...
        				<th align="center"><spring:message code="title.sample.description2" /></th>
        			...
        			<c:forEach var="result" items="${resultList}" varStatus="status">
            			<tr>
            				...
            				<td align="center" class="listtd"><c:out value="${result.useYn}"/>&nbsp;
            					<label id="${result.id}" style="display: none">${result.useYn}</label>
            				</td>
            				<td align="center" class="listtd"><c:out value="${result.description}"/>&nbsp;</td>
            				<td align="center" class="listtd"><c:out value="${result.description2}"/>&nbsp;</td>
